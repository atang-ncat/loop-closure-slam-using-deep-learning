...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/legacy/training_curves_v0_baseline.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.85\linewidth]{figures/legacy/pr_curves_v0_baseline_raw.png}
